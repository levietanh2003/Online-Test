...
public final class DialogNotifyBinding implements ViewBinding {
  ...
  private DialogNotifyBinding(@NonNull LinearLayout rootView, @NonNull AppCompatButton btnOK,
  ...
  public static DialogNotifyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogNotifyBinding((LinearLayout) rootView, btnOK, tvContent, tvTitle);
    }

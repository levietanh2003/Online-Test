...
public final class FragmentCurrencyBottomSheetBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentCurrencyBottomSheetBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static FragmentCurrencyBottomSheetBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentCurrencyBottomSheetBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_currency_bottom_sheet, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentCurrencyBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCurrencyBottomSheetBinding((LinearLayout) rootView, currencyListTitle,

...
public final class DialogErrorBinding implements ViewBinding {
  ...
  private DialogErrorBinding(@NonNull ConstraintLayout rootView, @NonNull AppCompatButton btnOK,
      @NonNull TextView tvContentError) {
  ...
  public static DialogErrorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvContentError;
      TextView tvContentError = ViewBindings.findChildViewById(rootView, id);
      if (tvContentError == null) {
        break missingId;
      }

      return new DialogErrorBinding((ConstraintLayout) rootView, btnOK, tvContentError);
    }

...
public final class DialogConfirmBinding implements ViewBinding {
  ...
  private DialogConfirmBinding(@NonNull LinearLayout rootView, @NonNull AppCompatButton btnNegative,
      @NonNull AppCompatButton btnPositive, @NonNull TextView tvContent,
  ...
  public static DialogConfirmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogConfirmBinding((LinearLayout) rootView, btnNegative, btnPositive, tvContent,
          tvTitle);
    }

...
public abstract class Hilt_CurrencyBottomSheetFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CurrencyBottomSheetFragment_GeneratedInjector) this.generatedComponent()).injectCurrencyBottomSheetFragment(UnsafeCasts.<CurrencyBottomSheetFragment>unsafeCast(this));
    }
  }
